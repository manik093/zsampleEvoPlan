		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsamplezcheckplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsamplezcheckplan-display": {
								"semanticObject": "comsamplezcheckplan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.zcheckplan",
									"url": sap.ui.require.toUrl("com/sample/zcheckplan")
								}
							}
						}
					}
